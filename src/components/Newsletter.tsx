...
const Newsletter: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden mx-auto ">
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-24 bg-gradient-to-br from-blue-500 to-blue-600 rounded-4xl p-8 md:px-12 lg:px-16">
